...
import io.github.gleidsonmt.gncontrols.controls.skin.EditorSkin;
...
public class Editor extends TextField {
    ...
    public String getUserAgentStylesheet() {
        return Objects.requireNonNull(FloatEditor.class.getResource("/agents/editor.css")).toExternalForm();
    }
