...
import io.github.gleidsonmt.gncontrols.controls.skin.GNTextBoxSkin;
...
//        setActionIcon(action);
    ...
    public String getUserAgentStylesheet() {
        return Objects.requireNonNull(GNTextBox.class.getResource("/agents/text_box.css")).toExternalForm();
    }
