...
public class GNDatePickerContent extends VBox {
    ...
    protected GNDatePickerSkin skin;
...
//    }
    ...
    GNDatePickerContent(final GNDatePicker datePicker, final GNDatePickerSkin skin) {
        this.datePicker = datePicker;
        this.skin = skin;

        getStyleClass().add("date-picker-popup");

//        this.getStylesheets().add(GNDatePickerContent.class.getResource("/datePopup.css").toExternalForm());
        this.getStylesheets().add(GNDatePickerContent.class.getResource("/datePopup.css").toExternalForm());
//        Objects.requireNonNull(getClass().getResource("/controls.css")).toExternalForm();
            ...
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                if(newValue != null){
                    displayedYearMonth.setValue(
                            YearMonth.of(Integer.parseInt(yearLabel.getText()), displayedYearMonth.get().getMonth())
