 ...
 */
public class GNRadioButtonSkin extends RadioButtonSkin {

    private final Circle circle = new Circle();
    private final Timeline timeline = new Timeline();
    private StackPane dot;
    private GNRadioButton control;

    public GNRadioButtonSkin(GNRadioButton control) {
        super(control);
        this.control = control;

        dot = (StackPane) control.lookup(".radio");
    ...
    private final EventHandler<MouseEvent> onPressed = event -> {
        ...
        timeline.getKeyFrames().setAll(
                ...
                new KeyFrame(Duration.millis(200), new KeyValue(circle.radiusProperty(), diameter + 5  ))
        );
