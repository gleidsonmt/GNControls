...
import io.gleidsonmt.controls.GNTextArea;
...
//        text.setOpacity(0);
    ...
    private final EventHandler<KeyEvent> maxEvent = new EventHandler<>() {
        ...
        public void handle(KeyEvent event) {
            System.out.println("control.getLength() = " + control.getLength());
            System.out.println("control.getMaxLength() = " + control.getMaxLength());
            if (control.getLength() >= control.getMaxLength().intValue()) {
